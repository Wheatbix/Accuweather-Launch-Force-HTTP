...
(function() {
        ...
        f(document).ready(function(c) {
            if (-1 != document.domain.indexOf("accuweather") || c(".aw-widget-legal").length) {
                ...
                var b = f(e.current.selector).add(e.threeday.selector)
                  , a = c();
                b.each(function() {
                    this.awInit || a.length || (a = c(this),
                    this.awType = -1 != a.data("uid").indexOf("awcc") ? "current" : "threeday",
                    this.awInit = !0)
                });
    ...
    function y(c) {
        ...
        f(e.current.selector).add(e.threeday.selector).each(function() {
            this.awInit && f(this).data("uid").substr(4) == c.data("uid").substr(4) && (a = f(this),
            a.data("locationkey", c.data("locationkey")),
            a.data("unit", c.data("unit")),
            -1 != a.data("uid").indexOf("awcc") ? (this.awType = "current",
            a.awType = "current") : (this.awType = "threeday",
            a.awType = "threeday"))
        });
        c.get(0).awInit = !0;
        ...
        a && (b = a.data(),
        b.widget = null,
        f.getJSON(e[a.awType].url + "?callback=?", b, function(c) {
            a.html(c.html);
            x(f, a)
        }))
    }
        ...
        (function(c) {
            c.autocomplete = function(b, a) {
                ...
                function m(a) {
                    var h = c("li", n);
                    h && (p += a,
                    0 > p ? p = 0 : p >= h.size() && (p = h.size() - 1),
                    h.removeClass("aw-ac-hover"),
                    c(h[p]).addClass("aw-ac-hover"),
                    h[p] && h[p].scrollIntoView && h[p].scrollIntoView(!1))
                }
                function k() {
                    w && clearTimeout(w);
                    n.hide()
                ...
                function v(a) {
                    ...
                    for (var c = [], h = 0; h < a.length; h++) {
                        ...
                        a[h] && (b = a[h],
                        d = [b.LocalizedName],
                        "US" == b.Country.ID || "CA" == b.Country.ID || "AU" == b.Country.ID ? d.push(", " + b.AdministrativeArea.ID) : "GB" == b.Country.ID ? void 0 !== b.SupplementalAdminAreas && b.SupplementalAdminAreas.length ? d.push(", " + b.SupplementalAdminAreas[0].LocalizedName) : d.push(", " + b.AdministrativeArea.ID) : b.AdministrativeArea.LocalizedName != b.LocalizedName && d.push(", " + b.AdministrativeArea.LocalizedName),
                        "US" == b.Country.ID ? d.push(" (USA)") : d.push(" (" + b.Country.LocalizedName + ")"),
                        d = d.join(""),
                        b = [],
                        b.push(d),
                        b.push(a[h].Key),
                ...
                if (null != a.data) {
                    ...
                    for (var B = 0; B < a.data.length; B++)
                        E = "string" == typeof a.data[B] ? [a.data[B]] : a.data[B],
                        0 < E[0].length && (D = E[0].substring(0, 1).toLowerCase(),
                        A[D] || (A[D] = []),
                        A[D].push(E));
                    for (var z in A)
                        a.cacheLength++,
                ...
                r.bind("keydown", function(b) {
                    ...
                    case 13:
                        var g = c("li", n);
                        b.preventDefault();
                        c(g).hasClass("aw-ac-hover") ? (b = n.closest(e.threeday.selector),
                        b.data("locationkey", c(g[p]).find("a").data("key")),
                        b.data("useip", "false"),
                        y(b)) : f();
                        break;
                    default:
                        ...
                        w = setTimeout(function() {
                            if (46 == C || 8 < C && 32 > C)
                                ...
                                b != l && (l = b,
                                b.length >= a.minChars ? (r.addClass(a.loadingClass),
                                d(b, "autocomplete")) : (r.removeClass(a.loadingClass),
                                n.hide()))
                            }
                        }, a.delay)
                    }
    ...
    function x(c, b) {
        ...
        window.accuweather.widgets.ThirtySixHour = function(a) {
            ...
            b.find(".aw-temp-unit").find("li a").each(function(a) {
                c(this).click(function() {
                    c(this).closest("li").hasClass("current") || (c(this).hasClass("aw-unit-f") ? b.data("unit", "f") : b.data("unit", "c"),
                    b.data("useip", "false"),
                    y(b))
                })
            });
                ...
                for (var k in awxWidgetInfo[d].wxInfo)
                    if ("ix" != k)
                        if ("cu" == k)
                            ...
                            awxWidgetInfo[d].wxInfo[k] && (awxWidgetInfo[d].keyValuePairs[k] = awxWidgetInfo[d].wxInfo[k].toString());
            this.resize();
            window.accuweather.widgets.register(this.el.get(0), this)
        }
        ;
    ...
    "undefined" != typeof oap3dayConfigDev ? (e.css = oap3dayConfigDev.css,
    e.threeday.selector = oap3dayConfigDev.threedaySelector,
    e.threeday.baseClass = oap3dayConfigDev.threedayBaseClass,
    e.threeday.url = oap3dayConfigDev.threedayUrl,
    e.current.selector = oap3dayConfigDev.currentSelector,
    e.current.baseClass = oap3dayConfigDev.currentBaseClass,
    e.current.url = oap3dayConfigDev.currentUrl) : (e.css = ["https://vortex.accuweather.com/adc2010/oap/stylesheets/widgets-20170109.css"],
    e.threeday.selector = ".aw-widget-36hour",
    e.threeday.baseClass = "aw-widget-36hour",
    e.threeday.url = "http://www.accuweather.com/ajax-service/oap/3day",
